        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <form className="space-y-4" onSubmit={handleSaveProfile}>
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditForm({
                      ...editForm,
                      profile_pictire: e.target.files[0],
                    })
                  }
                />
                <div className="relative group/profile">
                  <img
                    src={
                      editForm.profile_pictire
                        ? URL.createObjectURL(editForm.profile_pictire)
            ...
            <div className="flex flex-col items-start gap-3">
              <label
                htmlFor="cover_photo"
                className="bl text-sm font-medium text-gray-700 mb-1"
              >
                CoverPhoto
                <input
                  hidden
