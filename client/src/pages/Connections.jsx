                ...
                <div className="flex-1">
                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4 ">
                    ...
                    {currentTab === "Connections" && (
                      <button onClick={() => nevigate(`/messages/${user._id}`)}className="w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-slate-800 active:scale-95 transition cursor-pointer flex items-center justify-center gap-1">
